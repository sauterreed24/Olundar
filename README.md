...
- Aftermath Missions that place crisis follow-through tasks on the map, such as escort roads, repair scars, raider trails, and accord routes, with spawned sites, route chains, and terrain-specific rewards.
...
- When **Aftermath Missions** appear, use the Missions lens and send the required unit type to the marked site; some routes reveal a second waypoint and each site pays a terrain-specific reward.
...
- Aftermath missions must be generated by selected aftermath rulings, appear on the Missions lens, complete through unit movement, expose spawned sites and route-chain steps, and pay terrain-specific rewards.
...
1. Add visible mission-site art for road camps, raider camps, and envoy waystations on the canvas itself.
