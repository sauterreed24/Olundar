...
- Aftermath Missions that place crisis follow-through tasks on the map, such as escort roads, repair scars, raider trails, and accord routes, with visible site art, route chains, and terrain-specific rewards.
...
- When **Aftermath Missions** appear, use the Missions lens and send the required unit type to the marked site; camps, raider sites, accord waystations, and repair scars have distinct map art, some routes reveal a second waypoint, and each site pays a terrain-specific reward.
...
- Aftermath missions must be generated by selected aftermath rulings, appear on the Missions lens with distinct canvas site markers, complete through unit movement, expose spawned sites and route-chain steps, and pay terrain-specific rewards.
...
1. Add an optional mission-focus control that pans/highlights the next active mission target from the mission card.
