...
check('canvas renderer keeps premium tactical sprites readable', () => {
  ...
  assert(mainSource.includes('Gold outlines every legal terrain-cost move') && mainSource.includes('Blue outlines road-speed moves'), 'The live map help should explain legal movement outlines and road-speed movement at a glance.');
