...
check('canvas renderer keeps premium tactical sprites readable', () => {
  ...
  assert(mainSource.includes('function recommendedIronOrder') && mainSource.includes('function bestIronMineTarget') && mainSource.includes('function bestIronRoadAdvance') && mainSource.includes('function ironRouteProgressLabel') && mainSource.includes('route left to') && mainSource.includes('Extend iron road') && mainSource.includes('Advance along the iron road'), 'The iron opening directive should pursue a mine route with visible route-left progress instead of falling back to generic road or tower construction.');
